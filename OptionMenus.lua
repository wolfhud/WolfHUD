        ...
        local rainbow_pulse_options = {
            {type = "divider", size = 24}, {
                ...
                enabled_reqs = {
                    {
                        setting = {
                            "GADGETS", gadget_type, theme, theme_enabled_key,
                            "enabled"
                        },
                        invert = false
                    }
                ...
                visible_reqs = {
                    {
                        setting = {
                            "GADGETS", gadget_type, theme, "rainbow", "enabled"
                        },
                        invert = false
                    }
                },
                ...
                visible_reqs = {
                    {
                        setting = {
                            "GADGETS", gadget_type, theme, "pulse", "enabled"
                        },
                        invert = false
                    }
                },
            ...
            laser = {
                {
                    ...
                    visible_reqs = {can_be_deactivated},
                    enabled_reqs = {}
                }, {type = "divider", size = can_be_deactivated and 8 or 0}, {
                    type = "slider",
                    ...
                    enabled_reqs = {
                        {
                            setting = {
                                "GADGETS", "laser", theme, "beam", "enabled"
                            },
                            invert = false
                        },
                        {
                            setting = {
                                "GADGETS", "laser", theme, "rainbow", "enabled"
                            },
                            invert = true
                        }
                    },
                    ...
                    visible_reqs = {
                        {
                            setting = {
                                "GADGETS", "laser", theme, "dot", "match_beam"
                            },
                            invert = true
                        }
                    },
                    ...
                    visible_reqs = {
                        {
                            setting = {
                                "GADGETS", "laser", theme, "glow", "match_beam"
                            },
                            invert = true
                        }
                    },
            ...
            flashlight = {
                {
                    ...
                    enabled_reqs = {
                        {
                            setting = {
                                "GADGETS", "flashlight", theme, "light",
                                "enabled"
                            },
                            invert = false
                        }, {
                            setting = {
                                "GADGETS", "flashlight", theme, "rainbow",
                                "enabled"
                            },
                            invert = true
                        }
                    ...
                    value = {
                        "GADGETS", "flashlight", theme, "light", "brightness"
                    },
                    visible_reqs = {},
                    enabled_reqs = {},
                    min_value = 0,
        ...
        options = {
            {
                ...
                enabled_reqs = {},
                value = {"LANGUAGE"}
            }, {type = "divider", size = 12}, { -- General HUD
                type = "menu",
                ...
                options = {
                    {
                        ...
                        visible_reqs = {},
                        enabled_reqs = {}
                    }, {type = "divider", size = 8}, { -- CustomHUD Player
                        type = "menu",
                        ...
                        options = {
                            {
                                ...
                                value = {
                                    "CustomHUD", "PLAYER", "SPECIAL_EQUIPMENT"
                                }
                            }, {
                                type = "slider",
                                ...
                                value = {
                                    "CustomHUD", "PLAYER", "WEAPON", "FIREMODE"
                                }
                            }
                        }
                    }, { -- CustomHUD Teammate
                        ...
                        options = {
                            {
                                ...
                                enabled_reqs = {},
                                value = {
                                    "CustomHUD", "TEAMMATE", "TRUNCATE_TAGS"
                                }
                            }, {
                                type = "toggle",
                                name_id = "wolfhud_panels_show_char_title",
                                ...
                                value = {
                                    "CustomHUD", "TEAMMATE", "SPECIAL_EQUIPMENT"
                                }
                            }, {
                                type = "slider",
                                name_id = "wolfhud_panels_special_equip_rows_title",
                                ...
                                value = {
                                    "CustomHUD", "TEAMMATE", "WEAPON", "ICON"
                                }
                            }, {
                                type = "multi_choice",
                                name_id = "wolfhud_panels_weapon_name_title",
                                ...
                                value = {
                                    "CustomHUD", "TEAMMATE", "WEAPON", "NAME"
                                }
                            }, {
                                type = "multi_choice",
                                name_id = "wolfhud_panels_weapon_ammo_title",
                                ...
                                value = {
                                    "CustomHUD", "TEAMMATE", "WEAPON", "AMMO"
                                }
                            }, {
                                type = "multi_choice",
                                name_id = "wolfhud_panels_weapon_firemode_title",
                                ...
                                enabled_reqs = {},
                                value = {
                                    "CustomHUD", "TEAMMATE", "INTERACTION",
                                    "HIDE"
                                },
                                invert_value = true
                            }, {
                    ...
                    }, {type = "divider", size = 8}, { -- KillCounter
                        type = "menu",
                        ...
                        options = {
                            {
                                ...
                                enabled_reqs = {},
                                value = {
                                    "CustomHUD", "PLAYER", "KILLCOUNTER", "HIDE"
                                },
                                invert_value = true
                            }, {
                                type = "toggle",
                        ...
                        options = {
                            {
                                ...
                                enabled_reqs = {
                                    {
                                        setting = {
                                            "HUDSuspicion", "SHOW_PERCENTAGE"
                                        },
                                        invert = false
                                    }
                                },
                                value = {
                                    "HUDSuspicion", "SHOW_PERCENTAGE_OUTLINE"
                                }
                            }, {type = "divider", size = 24}, {
                                type = "toggle",
                                ...
                                enabled_reqs = {},
                                value = {
                                    "HUDSuspicion", "SHOW_PACIFIED_CIVILIANS"
                                }
                            }, {
                                type = "toggle",
                        ...
                        options = {
                            {
                                ...
                                enabled_reqs = {
                                    {
                                        setting = {"DamageIndicator", "ENABLED"},
                                        invert = false
                                    }
                                },
                                ...
                                value = {
                                    "DamageIndicator", "FRIENDLY_FIRE_COLOR"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                    ...
                    }, {type = "divider", size = 16}, { -- EnemyHealthbar
                        type = "menu",
                        ...
                        options = {
                            {
                                ...
                                enabled_reqs = {
                                    {
                                        setting = {"EnemyHealthbar", "ENABLED"},
                                        invert = false
                                    }
                                },
                    ...
                    }, {type = "divider", size = 16}, { -- drivingHUD
                        type = "menu",
                ...
                options = {
                    {
                        ...
                        max_value = 1.0,
                        step_size = 0.01
                    }, {type = "divider", size = 16}, { -- HUDList Left List
                        type = "menu",
                        ...
                        options = {
                            {
                                ...
                                value = {
                                    "HUDList", "LEFT_LIST", "show_ammo_bags"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                desc_id = "wolfhud_hudlist_show_equipment_desc",
                                value = {
                                    "HUDList", "LEFT_LIST", "show_doc_bags"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                desc_id = "wolfhud_hudlist_show_equipment_desc",
                                value = {
                                    "HUDList", "LEFT_LIST", "show_body_bags"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "LEFT_LIST", "show_sentries"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "LEFT_LIST", "show_ecm_retrigger"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "LEFT_LIST", "show_tape_loop"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                        ...
                        options = {
                            {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_enemies"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "aggregate_enemies"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_turrets"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_civilians"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_hostages"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_minion_count"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_pager_count"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_cam_count"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "show_corpse_count"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST", "aggregate_loot"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST",
                                    "SHOW_PICKUP_CATEGORIES", "mission_pickups"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST",
                                    "SHOW_PICKUP_CATEGORIES", "collectables"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "RIGHT_LIST",
                                    "SHOW_PICKUP_CATEGORIES", "valuables"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                        ...
                        options = {
                            {
                                ...
                                value = {
                                    "HUDList", "BUFF_LIST", "damage_increase"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "BUFF_LIST", "damage_reduction"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                value = {
                                    "HUDList", "BUFF_LIST", "total_dodge_chance"
                                },
                                visible_reqs = {},
                                enabled_reqs = {
                                    {
                                ...
                                options = {
                                    {
                                        ...
                                        value = {
                                            "HUDList", "BUFF_LIST",
                                            "MASTERMIND_BUFFS", "hostage_taker"
                                        },
                                        visible_reqs = {},
                                        enabled_reqs = {
                                            {
                                        ...
                                        value = {
                                            "HUDList", "BUFF_LIST",
                                            "MASTERMIND_BUFFS", "inspire_debuff"
                                        },
                                        visible_reqs = {},
                                        enabled_reqs = {
                                            {
                                ...
                                options = {
                                    {
                                        ...
                                        value = {
                                            "HUDList", "BUFF_LIST",
                                            "ENFORCER_BUFFS", "bullseye_debuff"
                                        },
                                        visible_reqs = {},
                                        enabled_reqs = {
                                            {
                                ...
                                options = {
                                    {
                                        ...
                                        value = {
                                            "HUDList", "BUFF_LIST",
                                            "FUGITIVE_BUFFS", "bloodthirst_aced"
                                        },
                                        visible_reqs = {},
                                        enabled_reqs = {
                                            {
                                ...
                                options = {
                                    {
                                        ...
                                        value = {
                                            "HUDList", "BUFF_LIST",
                                            "PERK_BUFFS", "ammo_give_out_debuff"
                                        },
                                        visible_reqs = {},
                                        enabled_reqs = {
                                            {
                                        ...
                                        value = {
                                            "HUDList", "BUFF_LIST",
                                            "PERK_BUFFS", "smoke_screen_grenade"
                                        },
                                        visible_reqs = {},
                                        enabled_reqs = {
                                            {
                ...
                options = {
                    {
                        ...
                        enabled_reqs = {
                            {
                                setting = {"CustomWaypoints", "LOOT", "SHOW"},
                                invert = false
                            }
                        }
                    }, {
            ...
            }, {type = "divider", size = 8}, { -- INTERACTION
                type = "menu",
                ...
                options = {
                    {
                        ...
                        enabled_reqs = {
                            {
                                setting = {"INTERACTION", "SHOW_TIME_REMAINING"},
                                invert = false
                            }
                        },
                        min_value = 0.3,
                        ...
                        enabled_reqs = {
                            ...
                            {
                                setting = {"INTERACTION", "SHOW_CIRCLE"},
                                invert = false
                            }
                        }
                    }, {
                ...
                options = {
                    {
                        ...
                        options = get_gadget_options("laser",
            ...
            }, {type = "divider", size = 16}, -- INVENTORY & EQUIPMENT
            {
                type = "menu",
