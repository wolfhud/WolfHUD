...
if not WolfHUD:getSetting({"CustomHUD", "ENABLED"}, true) then return end
...
if RequiredScript == "lib/managers/hud/hudteammate" then
    ...
    HUDTeammateCustom.SETTINGS = {
        ...
        PLAYER = {
            ...
            OPACITY = WolfHUD:getSetting({"CustomHUD", "PLAYER", "OPACITY"},
                                         0.85), -- Transparency/alpha of panel (1 is solid, 0 is invisible)

            NAME = WolfHUD:getSetting({"CustomHUD", "PLAYER", "NAME"}, false), -- Show name
            TRUNCATE_TAGS = WolfHUD:getSetting(
                {"CustomHUD", "PLAYER", "TRUNCATE_TAGS"}, false), -- Truncate tags
            RANK = WolfHUD:getSetting({"CustomHUD", "PLAYER", "RANK"}, false), -- Show infamy/level
            CHARACTER = WolfHUD:getSetting({"CustomHUD", "PLAYER", "CHARACTER"},
                                           false), -- Show character name
            ...
            CONDITION_ICON_COLOR = WolfHUD:getColorSetting(
                {"CustomHUD", "PLAYER", "CONDITION_ICON_COLOR"}, "white"),
            EQUIPMENT = WolfHUD:getSetting({"CustomHUD", "PLAYER", "EQUIPMENT"},
                                           true), -- Show throwables, cable ties and deployables
            SPECIAL_EQUIPMENT = WolfHUD:getSetting(
                {"CustomHUD", "PLAYER", "SPECIAL_EQUIPMENT"}, true), -- Show special equipment/tools (keycards etc.)
            SPECIAL_EQUIPMENT_ROWS = WolfHUD:getSetting(
                {"CustomHUD", "PLAYER", "SPECIAL_EQUIPMENT_ROWS"}, 3),
            CALLSIGN = WolfHUD:getSetting({"CustomHUD", "PLAYER", "CALLSIGN"},
                                          false), -- Show the callsign and voice chat icon
            STAMINA = WolfHUD:getSetting({"CustomHUD", "PLAYER", "STAMINA"},
                                         true),
            DOWNCOUNTER = WolfHUD:getSetting(
                {"CustomHUD", "PLAYER", "DOWNCOUNTER"}, true),
            ...
            WEAPON = {
                ...
                ICON = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "ICON"}, 4) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "ICON"}, 4) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "ICON"}, 4) == 3)
                },
                NAME = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "NAME"}, 1) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "NAME"}, 1) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "NAME"}, 1) == 3)
                },
                AMMO = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "AMMO"}, 4) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "AMMO"}, 4) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "AMMO"}, 4) == 3),
                    TOTAL_AMMO_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "AMMO"}, 4) == 5) -- Shows only total ammo for all weapons
                },
                FIREMODE = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "FIREMODE"}, 2) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "FIREMODE"}, 2) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "PLAYER", "WEAPON", "FIREMODE"}, 2) == 3)
                }
            },
            ...
            KILLCOUNTER = {
                ...
                HIDE = WolfHUD:getSetting(
                    {"CustomHUD", "PLAYER", "KILLCOUNTER", "HIDE"}, false), -- Hides the kill counter
                SHOW_BOT_KILLS = false, -- Show the kill counter for criminal bots
                SHOW_SPECIAL_KILLS = WolfHUD:getSetting(
                    {"CustomHUD", "PLAYER", "KILLCOUNTER", "SHOW_SPECIAL_KILLS"},
                    true), -- Separate counter for specials
                SHOW_HEADSHOT_KILLS = WolfHUD:getSetting(
                    {
                        "CustomHUD", "PLAYER", "KILLCOUNTER",
                        "SHOW_HEADSHOT_KILLS"
                    }, true), -- Separate counter, of how many kills were due to headshots
                COLOR = WolfHUD:getColorSetting(
                    {"CustomHUD", "PLAYER", "KILLCOUNTER", "COLOR"}, "yellow")
            },
            SHOW_ACCURACY = WolfHUD:getSetting(
                {"CustomHUD", "PLAYER", "SHOW_ACCURACY"}, true) -- Show accuracy information
        },

        TEAMMATE = {
            SCALE = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "SCALE"}, 0.8), -- Scale of all elements of the panel
            OPACITY = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "OPACITY"},
                                         0.85), -- Transparency/alpha of panel (1 is solid, 0 is invisible)

            NAME = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "NAME"}, true), -- Show name
            TRUNCATE_TAGS = WolfHUD:getSetting(
                {"CustomHUD", "TEAMMATE", "TRUNCATE_TAGS"}, false), -- Truncate tags
            RANK = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "RANK"}, true), -- Show infamy/level
            CHARACTER = WolfHUD:getSetting(
                {"CustomHUD", "TEAMMATE", "CHARACTER"}, false), -- Show character name
            LATENCY = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "LATENCY"},
                                         true), -- Show latency (not used by player panel)
            STATUS = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "STATUS"},
                                        true), -- Show health/armor/condition etc.
            CONDITION_ICON_COLOR = WolfHUD:getColorSetting(
                {"CustomHUD", "TEAMMATE", "CONDITION_ICON_COLOR"}, "white"),
            EQUIPMENT = WolfHUD:getSetting(
                {"CustomHUD", "TEAMMATE", "EQUIPMENT"}, true), -- Show throwables, cable ties and deployables
            SPECIAL_EQUIPMENT = WolfHUD:getSetting(
                {"CustomHUD", "TEAMMATE", "SPECIAL_EQUIPMENT"}, true), -- Show special equipment/tools (keycards etc.)
            SPECIAL_EQUIPMENT_ROWS = WolfHUD:getSetting(
                {"CustomHUD", "TEAMMATE", "SPECIAL_EQUIPMENT_ROWS"}, 3),
            CALLSIGN = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "CALLSIGN"},
                                          false), -- Show the callsign and voice chat icon
            STAMINA = false,
            DOWNCOUNTER = WolfHUD:getSetting(
                {"CustomHUD", "TEAMMATE", "DOWNCOUNTER"}, true),
            CARRY = WolfHUD:getSetting({"CustomHUD", "TEAMMATE", "CARRY"}, true), -- Show currently carried bag
            BUILD = { -- Show perk deck and number of skills acquired in each tree (not used by player)
                -- Pick max one
                HIDE = WolfHUD:getSetting(
                    {"CustomHUD", "TEAMMATE", "BUILD", "HIDE"}, false), -- Don't show build at all
                DURATION = WolfHUD:getSetting(
                    {"CustomHUD", "TEAMMATE", "BUILD", "DURATION"}, 15) > 0 and
                    WolfHUD:getSetting({
                        "CustomHUD", "TEAMMATE", "BUILD", "DURATION"
                    }, 15) or nil -- Time in seconds to show the build from when player joins. Information is hidden when duration has expired, or never removed if value is nil/undefined
            },
            WEAPON = {
                -- Show/hide various elements of the weapons panels.
                -- HIDE option hides the element. SELECTED_ONLY shows only if the weapon is currently selected, UNSELECTED_ONLY the reverse
                ...
                ICON = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "ICON"}, 4) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "ICON"}, 4) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "ICON"}, 4) == 3)
                },
                NAME = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "NAME"}, 1) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "NAME"}, 1) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "NAME"}, 1) == 3)
                },
                AMMO = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "AMMO"}, 4) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "AMMO"}, 4) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "AMMO"}, 4) == 3),
                    TOTAL_AMMO_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "AMMO"}, 4) == 5) -- Shows only total ammo for all weapons
                },
                FIREMODE = {
                    HIDE = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "FIREMODE"}, 1) == 1),
                    SELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "FIREMODE"}, 1) == 2),
                    UNSELECTED_ONLY = (WolfHUD:getSetting(
                        {"CustomHUD", "TEAMMATE", "WEAPON", "FIREMODE"}, 1) == 3)
                }
            },
            INTERACTION = { -- (Interaction display only used by teammates, included for reference)
                HIDE = WolfHUD:getSetting(
                    {"CustomHUD", "TEAMMATE", "INTERACTION", "HIDE"}, false), -- Hides the interaction activity/time/progress
                MIN_DURATION = WolfHUD:getSetting(
                    {"CustomHUD", "TEAMMATE", "INTERACTION", "MIN_DURATION"}, 1) -- Shows the interaction display only if interaction duration in seconds exceeds this threshold
            },
            KILLCOUNTER = {
                -- Requires external plugin to be loaded, else will be disabled no matter what
                HIDE = WolfHUD:getSetting(
                    {"CustomHUD", "TEAMMATE", "KILLCOUNTER", "HIDE"}, false), -- Hides the kill counter
                SHOW_BOT_KILLS = WolfHUD:getSetting(
                    {"CustomHUD", "TEAMMATE", "KILLCOUNTER", "SHOW_BOT_KILLS"},
                    true), -- Show the kill counter for criminal bots
                SHOW_SPECIAL_KILLS = WolfHUD:getSetting(
                    {
                        "CustomHUD", "TEAMMATE", "KILLCOUNTER",
                        "SHOW_SPECIAL_KILLS"
                    }, true), -- Separate counter for specials
                SHOW_HEADSHOT_KILLS = WolfHUD:getSetting(
                    {
                ...
                COLOR = WolfHUD:getColorSetting(
                    {"CustomHUD", "TEAMMATE", "KILLCOUNTER", "COLOR"}, "yellow")
            },
    ...
    function HUDTeammateCustom:init(id, panel, is_player, alignment)
        self._panel = panel:panel({name = "teammate_panel_" .. tostring(id)})

        self._align = alignment
        self._listeners = {}
        self._all_components = {}
        self._settings = HUDTeammateCustom.SETTINGS[is_player and "PLAYER" or
                             "TEAMMATE"]
        self._id = id
    ...
    function HUDTeammateCustom:arrange()
        ...
        if self._is_player then self._carry:set_center_x(w / 2) end

        self._latency:set_right(w)
        self._waiting_input:set_right(w)

        if not (self._latency:visible() or self._player_info:visible()) and
            self._player_status:visible() then
    ...
    function HUDTeammateCustom:_build_panel()
        ...
        self._player_info = PlayerInfoComponent.PlayerInfo:new(self._panel,
                                                               self, name_size,
                                                               self._settings)
        self._latency = PlayerInfoComponent.Latency:new(self._panel, self,
                                                        name_size,
                                                        self._settings)
        self._build = PlayerInfoComponent.Build:new(self._panel, self,
                                                    name_size, self._settings)
        self._callsign = PlayerInfoComponent.Callsign:new(self._panel, self,
                                                          name_size,
                                                          self._settings)
        self._player_status = PlayerInfoComponent.PlayerStatus:new(self._panel,
                                                                   self, size,
                                                                   size,
                                                                   self._settings)
        self._waiting_status = PlayerInfoComponent.WaitingStatus:new(
                                   self._panel, self, size, size, self._settings)
        self._accuracy = PlayerInfoComponent.AccuracyCounter:new(self._panel,
                                                                 self,
                                                                 name_size * 0.8,
                                                                 self._settings)
        self._kills = PlayerInfoComponent.KillCounter:new(self._panel, self,
                                                          name_size * 0.8,
                                                          self._settings)
        self._waiting_input = PlayerInfoComponent.WaitingInput:new(self._panel,
                                                                   self,
                                                                   name_size *
                                                                       0.8,
                                                                   self._settings)
        self._carry = PlayerInfoComponent.Carry:new(self._panel, self,
                                                    name_size, size,
                                                    self._settings)
        self._center_panel = PlayerInfoComponent.CenterPanel:new(self._panel,
                                                                 self, size,
                                                                 self._settings)

        self._all_components = {
            self._player_info, self._latency, self._build, self._accuracy,
            self._kills, self._waiting_input, self._callsign,
            self._player_status, self._waiting_status, self._carry,
            self._center_panel
        }
    ...
    function HUDTeammateCustom:_rebuild_layout()
        ...
        if self._latency:visible() or self._player_info:visible() or
            not self._player_status:visible() then
        ...
        local center_components = {
            self._player_status, self._waiting_status, self._center_panel
        }
        ...
        table.insert(self._component_layout,
                     {self._kills, self._accuracy, self._waiting_input}) -- 5th row
    ...
    function HUDTeammateCustom:peer_id() return self._peer_id end

    function HUDTeammateCustom:is_local_player()
        return not (self:peer_id() or self:is_ai())
    end

    function HUDTeammateCustom:name() return self._last_name or "" end

    function HUDTeammateCustom:is_ai() return self._ai end

    function HUDTeammateCustom:is_ai_stopped()
        return self._ai and self._ai_stopped or false
    end

    function HUDTeammateCustom:is_waiting() return self._is_waiting or false end

    function HUDTeammateCustom:alignment() return self._align end

    function HUDTeammateCustom:panel() return self._panel end

    function HUDTeammateCustom:register_listener(id, events, clbk, prefix_event)
        for _, event in pairs(events) do
            self._listeners[event] = self._listeners[event] or {}
            self._listeners[event][id] =
                {clbk = clbk, prefix_event = prefix_event}
        end
    end
    ...
    function HUDTeammateCustom:activate_ability_radial(time_left, time_total) -- Teammates, handled in update function.
        self:call_listeners("activate_ability", time_left,
                            time_total or time_left)

        if self:is_local_player() then
            local current_time = managers.game_play_central:get_heist_timer() or
                                     0
            managers.network:session():send_to_peers("sync_ability_hud",
    ...
    function HUDTeammateCustom:set_delayed_damage(damage)
        ...
        if self:is_local_player() then
            managers.network:session():send_to_peers("sync_delayed_damage_hud",
                                                     damage)
        end
    end
    ...
    function HUDTeammateCustom:set_ammo_amount_by_type(slot, mag_max,
                                                       mag_current,
                                                       total_current, total_max)
        local slot_index = {primary = 2, secondary = 1}
        self:call_listeners("ammo_amount", slot_index[slot], mag_current,
                            mag_max, total_current, total_max)
    end
        ...
        if data and data.end_time and data.duration then
            ...
            if self:is_local_player() then
                managers.network:session():send_to_peers(
                    "sync_grenades_cooldown", data.end_time, data.duration)
            end
        end
    end
    ...
    function HUDTeammateCustom:set_cable_ties_amount(amount)
        if amount then self:call_listeners("cable_tie_amount", amount) end
    end
    ...
    function HUDTeammateCustom:set_deployable_equipment_amount_from_string(
        index, data)
        if data.amount then
    ...
    function HUDTeammateCustom:clear_special_equipment(override)
        ...
        if not override then self:reset() end
    ...
    function HUDTeammateCustom:set_callsign(id)
        if self:is_local_player() then
            ...
            self:set_rank(managers.experience:current_rank(),
                          managers.experience:current_level())
            local detection =
                managers.blackmarket:get_suspicion_offset_of_local(
    ...
    function HUDTeammateCustom:set_peer_id(peer_id)
        ...
        if peer_id then
            ...
            self:set_character(managers.criminals:character_name_by_peer_id(
                                   peer_id))
            self:set_rank(peer:rank(), peer:level())
        end
    end

    function HUDTeammateCustom:set_ai(status) self._ai = status end
    ...
    function HUDTeammateCustom:set_waiting(status, peer)
        ...
        if status then
            ...
            outfit = outfit or
                         managers.blackmarket:unpack_outfit_from_string(
                             peer:profile().outfit_string) or {}
            if outfit.deployable then
                local amount = outfit.deployable_amount or 0
                if type(amount) == "table" then
                    self:set_deployable_equipment_from_string(
                        {
                            icon = tweak_data.equipments[outfit.deployable].icon,
                            amount = amount
                        })
                else
                    self:set_deployable_equipment(
                        {
                            icon = tweak_data.equipments[outfit.deployable].icon,
                            amount = amount
                        })
            ...
            if outfit.secondary_deployable then
                ...
                self:set_cable_tie({
                    icon = tweak_data.equipments[outfit.secondary_deployable]
                        .icon,
                    amount = amount
                })
            end
            if outfit.grenade then
                self:set_grenades({
                    icon = tweak_data.blackmarket.projectiles[outfit.grenade]
                        .icon,
                    amount = managers.player:get_max_grenades(peer:grenade_id())
                })
            end
        else
            local character = managers.criminals:character_name_by_panel_id(
                                  self._id)
            if character then
    ...
    function HUDTeammateCustom:teammate_progress(enabled, tweak_id, timer,
                                                 success)
        if enabled then
    ...
    function HUDTeammateCustom:reset_accuracy() self:set_accuracy(0) end
    ...
    for id, ptr in pairs(HUDTeammate) do
        if type(ptr) == "function" then
            HUDTeammateCustom[id] = HUDTeammateCustom[id] or function(self, ...)
                print_warning(
                    "HUDTeammateCustom: Unoverridden function call: %s", id)
            end
        end
    end
    ...
    function PlayerInfoComponent.Base:init(base_panel, owner, name, width,
                                           height)
        self._name = name
        ...
        self._panel = self._owner_panel:panel(
                          {name = name, h = height or 0, w = width or 0})
    end
    ...
    function PlayerInfoComponent.Base:center_x()
        return self._panel:center_x()
    end
    function PlayerInfoComponent.Base:center_y()
    ...
    function PlayerInfoComponent.Base:set_center(x, y)
        self._panel:set_center(x, y)
    end
    function PlayerInfoComponent.Base:set_center_x(v)
        self._panel:set_center_x(v)
    end
    function PlayerInfoComponent.Base:set_center_y(v)
    ...
    function PlayerInfoComponent.Base.get_item_icon_data(type, id)
        ...
        local bundle_folder = tweak_entry[type][id] and
                                  tweak_entry[type][id].texture_bundle_folder
        local guis_catalog = string.format("guis/%s", bundle_folder and
                                               string.format("dlcs/%s/",
                                                             tostring(
                                                                 bundle_folder)) or
                                               "")
        local texture_name = tweak_entry[type][id] and
                                 tweak_entry[type][id].texture_name or
                                 tostring(id)
        local texture = string.format("%s%s%s", guis_catalog,
                                      texture_path[type], texture_name)
        ...
        local name_id =
            tweak_entry[type][id] and tweak_entry[type][id].name_id or
                tostring(id)
    ...
    PlayerInfoComponent.PlayerInfo = PlayerInfoComponent.PlayerInfo or
                                         class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.PlayerInfo:init(panel, owner, height, settings)
        PlayerInfoComponent.PlayerInfo.super.init(self, panel, owner,
                                                  "player_info", 0, height)
        ...
        self._owner:register_listener("PlayerInfo", {"callsign"},
                                      callback(self, self, "set_id"), false)
        self._owner:register_listener("PlayerInfo", {"name"},
                                      callback(self, self, "set_name"), false)
        self._owner:register_listener("PlayerInfo", {"character"},
                                      callback(self, self, "set_character"),
                                      false)
        self._owner:register_listener("PlayerInfo", {"rank"},
                                      callback(self, self, "set_rank"), false)
        self._owner:register_listener("PlayerInfo", {"cheater"},
                                      callback(self, self, "set_cheater"), false)
    end

    function PlayerInfoComponent.PlayerInfo:destroy()
        self._owner:unregister_listener("PlayerInfo", {
            "callsign", "name", "character", "rank"
        })
    ...
    function PlayerInfoComponent.PlayerInfo:update_settings()
        self:set_enabled("setting",
                         self._settings.NAME or self._settings.RANK or
                             self._settings.CHARACTER)
    ...
    function PlayerInfoComponent.PlayerInfo:set_id(id)
        self._id = id
        self:_set_text_color((id == 5 and
                                 WolfHUD:getSetting(
                                     {
                    "CustomHUD", "TEAMMATE", "AI_COLOR", "USE"
                }, false)) and
                                 WolfHUD:getColorSetting(
                                     {
                    "CustomHUD", "TEAMMATE", "AI_COLOR", "COLOR"
                }, "white") or tweak_data.chat_colors[id])
    end
    ...
    function PlayerInfoComponent.PlayerInfo:set_character(character)
        if character then
            local str = string.format("(%s)", managers.localization:text(
                                          "menu_" .. character))
    ...
    function PlayerInfoComponent.PlayerInfo:set_rank(infamy, level)
        if level then
            local str = string.format("[%s%s]", (infamy or 0) > 0 and
                                          string.format("%s-",
                                                        managers.experience:rank_string(
                                                            infamy)) or "",
                                      tostring(level))
    ...
    function PlayerInfoComponent.PlayerInfo:_update_component_visibility()
        ...
        self._components.character:set_visible(
            self._settings.CHARACTER and not self._is_ai)
        self._components.rank:set_visible(
            self._settings.RANK and not self._is_ai)
        self:arrange()
    end
    ...
    PlayerInfoComponent.Latency = PlayerInfoComponent.Latency or
                                      class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Latency:init(panel, owner, height, settings)
        PlayerInfoComponent.Latency.super.init(self, panel, owner, "latency",
                                               height * 2, height)
        ...
        self._owner:register_listener("Latency", {"latency"},
                                      callback(self, self, "set_latency"), false)
    end
    ...
    function PlayerInfoComponent.Latency:set_is_ai(state)
        if PlayerInfoComponent.Latency.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end

    function PlayerInfoComponent.Latency:set_is_local_player(state)
        if PlayerInfoComponent.Latency.super.set_is_local_player(self, state) and
            self:set_enabled("player", not self._is_local_player) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.Latency:set_latency(value)
        if type(value) == "number" then
            ...
            self._text:set_color(
                value < 75 and Color('C2FC97') or value < 150 and
                    Color('CEA168') or Color('E24E4E'))
        else
    ...
    PlayerInfoComponent.Build = PlayerInfoComponent.Build or
                                    class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Build:init(panel, owner, height, settings)
        PlayerInfoComponent.Build.super.init(self, panel, owner, "build", 0,
                                             height)
        ...
        self._owner:register_listener("Build", {"specialization"}, callback(
                                          self, self, "set_specialization"),
                                      false)
        self._owner:register_listener("Build", {"skills"},
                                      callback(self, self, "set_skills"), false)
    end
    ...
    function PlayerInfoComponent.Build:rescale(factor)
        if PlayerInfoComponent.Build.super.rescale(self, factore) then
            ...
            self._specialization:set_font_size(
                self._specialization:font_size() * factor)
            self._skills:set_font_size(self._skills:font_size() * factor)
        end
    end

    function PlayerInfoComponent.Build:set_is_ai(state)
        if PlayerInfoComponent.Build.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.Build:set_is_local_player(state)
        if PlayerInfoComponent.Build.super.set_is_local_player(self, state) and
            self:set_enabled("player", not self._is_local_player) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.Build:arrange()
        ...
        if self:set_size(w, self._panel:h()) then self._owner:arrange() end
    end
    ...
    function PlayerInfoComponent.Build:set_skills(data)
        ...
        for i, tree in ipairs(tweak_data.skilltree.skill_pages_order) do
            ...
            if tree then
                table.insert(trees,
                             tree.name_id and
                                 utf8.sub(
                                     managers.localization:text(tree.name_id),
                                     1, 1) or "?")
            end
        end
        ...
        for tree = 1, #trees, 1 do
            ...
            for sub_tree = 1, subtree_amt, 1 do
                ...
                skill_string = string.format("%s%02d%s", skill_string,
                                             tonumber(skills),
                                             sub_tree < 3 and "|" or "")
            ...
            if tree_has_points then
                text = string.format("%s%s:%s%s", text,
                                     trees[tree] or tostring(tree),
                                     skill_string, tree < #trees and " " or "")
            end
        end
    ...
    function PlayerInfoComponent.Build:_expire(panel)
        ...
        local t = 0
        while t < self._duration do t = t + coroutine.yield() end
    ...
    PlayerInfoComponent.KillCounter = PlayerInfoComponent.KillCounter or
                                          class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.KillCounter:init(panel, owner, height, settings)
        PlayerInfoComponent.KillCounter.super.init(self, panel, owner,
                                                   "kill_counter", 0, height)
        ...
        self._owner:register_listener("KillCounter", {"increment_kill_count"},
                                      callback(self, self, "increment"), false)
        self._owner:register_listener("KillCounter", {"reset_kill_count"},
                                      callback(self, self, "reset"), false)
    end

    function PlayerInfoComponent.KillCounter:destroy()
        self._owner:unregister_listener("KillCounter", {
            "increment_kill_count", "reset_kill_count"
        })
    ...
    function PlayerInfoComponent.KillCounter:update_settings()
        local setting = self:set_enabled("setting",
                                         not self._settings.KILLCOUNTER.HIDE)
        local plugin =
            self:set_enabled("plugin", HUDManager.KILL_COUNTER_PLUGIN)
        local ai = self:set_enabled("ai", self._settings.KILLCOUNTER
                                        .SHOW_BOT_KILLS or not self._is_ai)
    ...
    function PlayerInfoComponent.KillCounter:set_is_ai(state)
        if PlayerInfoComponent.KillCounter.super.set_is_ai(self, state) and
            self:set_enabled("ai", self._settings.KILLCOUNTER.SHOW_BOT_KILLS or
                                 not self._is_ai) then
            self._owner:arrange()
        end
    end

    function PlayerInfoComponent.KillCounter:set_is_waiting(state)
        if PlayerInfoComponent.KillCounter.super.set_is_waiting(self, state) and
            self:set_enabled("waiting", not self._is_waiting) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.KillCounter:_update_text()
        if self._settings.KILLCOUNTER.SHOW_SPECIAL_KILLS and
            self._settings.KILLCOUNTER.SHOW_HEADSHOT_KILLS then
            self._text:set_text(string.format("%d/%d (%d)", self._kills,
                                              self._special_kills,
                                              self._headshot_kills))
        elseif self._settings.KILLCOUNTER.SHOW_SPECIAL_KILLS then
            self._text:set_text(string.format("%d/%d", self._kills,
                                              self._special_kills))
    ...
    PlayerInfoComponent.AccuracyCounter =
        PlayerInfoComponent.AccuracyCounter or class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.AccuracyCounter:init(panel, owner, height,
                                                      settings)
        PlayerInfoComponent.AccuracyCounter.super.init(self, panel, owner,
                                                       "accuracy_counter", 0,
                                                       height)
        ...
        self._owner:register_listener("AccuracyCounter", {"accuracy"},
                                      callback(self, self, "set_accuracy"),
                                      false)
    end
    ...
    function PlayerInfoComponent.AccuracyCounter:update_settings()
        local setting =
            self:set_enabled("setting", self._settings.SHOW_ACCURACY)
        local plugin = self:set_enabled("plugin", HUDManager.ACCURACY_PLUGIN)

        if setting or plugin then self._owner:arrange() end
    end
    ...
    function PlayerInfoComponent.AccuracyCounter:set_is_local_player(state)
        if PlayerInfoComponent.AccuracyCounter.super.set_is_local_player(self,
                                                                         state) and
            self:set_enabled("player", self._is_local_player) then
            self._owner:arrange()
        end
    end

    function PlayerInfoComponent.AccuracyCounter:set_is_waiting(state)
        if PlayerInfoComponent.AccuracyCounter.super.set_is_waiting(self, state) and
            self:set_enabled("waiting", not self._is_waiting) then
            self._owner:arrange()
        end
    end
    ...
    PlayerInfoComponent.WaitingInput = PlayerInfoComponent.WaitingInput or
                                           class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.WaitingInput:init(panel, owner, height,
                                                   settings)
        PlayerInfoComponent.WaitingInput.super.init(self, panel, owner,
                                                    "waiting_input", 0, height)
        ...
        for i, btn in ipairs(buttons or {}) do
            local button_text = managers.localization:btn_macro(btn.binding,
                                                                true, true)
            if button_text then
        ...
        if self:set_size(self._text:right() + (2 * PADDING),
                         self._panel:h() + PADDING) then
            self._panel:rect({
                name = "bg",
                color = Color.black,
                alpha = 0.5,
    ...
    function PlayerInfoComponent.WaitingInput:set_is_ai(state)
        if PlayerInfoComponent.WaitingInput.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.WaitingInput:set_is_local_player(state)
        if PlayerInfoComponent.WaitingInput.super.set_is_local_player(self,
                                                                      state) and
            self:set_enabled("player", not self._is_local_player) then
            self._owner:arrange()
        end
    ...
    function PlayerInfoComponent.WaitingInput:set_is_waiting(state)
        if PlayerInfoComponent.WaitingInput.super.set_is_waiting(self, state) and
            self:set_enabled("waiting", self._is_waiting) then
            self._owner:arrange()
            if self:enabled() and not self._animating_input_required then
                self._animating_input_required = true
                self._text:animate(callback(self, self,
                                            "_animate_input_required"))
    ...
    function PlayerInfoComponent.WaitingInput:_animate_input_required(text)
        ...
        while self._animating_input_required do
            t = t + coroutine.yield()
            text:set_color(Color(1, 1, 1,
                                 1 - (0.5 * math.sin(t * 240 * 2) + 0.5)))
        end
        text:set_color(Color(1, 1, 1, 1))
    end

    PlayerInfoComponent.Callsign = PlayerInfoComponent.Callsign or
                                       class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Callsign:init(panel, owner, size, settings)
        PlayerInfoComponent.Callsign.super.init(self, panel, owner, "callsign",
                                                size, size)
        ...
        self._owner:register_listener("Callsign", {"callsign"},
                                      callback(self, self, "set_id"), false)
        self._owner:register_listener("Callsign", {"voice_com"}, callback(self,
                                                                          self,
                                                                          "set_voice_com_active"),
                                      false)
        self._owner:register_listener("Callsign", {"condition"},
                                      callback(self, self, "set_condition"),
                                      false)
    end

    function PlayerInfoComponent.Callsign:destroy()
        self._owner:unregister_listener("Callsign",
                                        {"callsign", "voice_com", "condition"})
    ...
    function PlayerInfoComponent.Callsign:rescale(factor)
        if PlayerInfoComponent.Callsign.super.rescale(self, factor) then
            ...
            self._condition_icon:set_center(self._panel:w() / 2,
                                            self._panel:h() / 2)
        end
    end
    ...
    function PlayerInfoComponent.Callsign:set_condition(icon_data)
        ...
        if visible then
            local icon, texture_rect = tweak_data.hud_icons:get_icon_data(
                                           icon_data)
            self._condition_icon:set_image(icon, unpack(texture_rect))
            self._condition_icon:set_w(self._size *
                                           math.min(
                                               texture_rect[3] / texture_rect[4],
                                               1))
            self._condition_icon:set_h(self._size *
                                           math.min(
                                               texture_rect[4] / texture_rect[3],
                                               1))
            self._condition_icon:set_center(self._panel:w() / 2,
                                            self._panel:h() / 2)
        end
    ...
    PlayerInfoComponent.PlayerStatus = PlayerInfoComponent.PlayerStatus or
                                           class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.PlayerStatus:init(panel, owner, width, height,
                                                   settings)
        PlayerInfoComponent.PlayerStatus.super.init(self, panel, owner,
                                                    "player_status", width,
                                                    height)
        ...
        self._health_radial:set_texture_rect(
            self._health_radial:texture_width(), 0,
            -self._health_radial:texture_width(),
            self._health_radial:texture_height())
        ...
        self._stored_health_radial:set_texture_rect(
            self._stored_health_radial:texture_width(), 0,
            -self._stored_health_radial:texture_width(),
            self._stored_health_radial:texture_height())
        ...
        self._armor_radial:set_texture_rect(self._armor_radial:texture_width(),
                                            0,
                                            -self._armor_radial:texture_width(),
                                            self._armor_radial:texture_height())
        ...
        self._downs_counter = self._panel:text(
                ...
                layer = self._health_radial:layer() + 1,
                visible = HUDManager.DOWNS_COUNTER_PLUGIN and
                    self._settings.DOWNCOUNTER or false
            })
        ...
        self._radial_delayed_damage_armor =
            self._panel:bitmap({
        ...
        self._radial_delayed_damage_health =
            self._panel:bitmap({
        ...
        self._components = {
            health_bg, self._health_radial, self._stored_health_radial,
            self._armor_radial, --[[self._stamina_radial,]]
            self._damage_indicator, self._downs_counter,
            self._detection_counter, center_bg, self._condition_icon,
            self._custom_radial_icon, self._ability_radial_icon,
            self._maniac_absorb_radial, self._radial_delayed_damage_armor,
            self._radial_delayed_damage_health
        }

        local tweak = tweak_data.upgrades
        self._max_absorb = tweak.cocaine_stacks_dmg_absorption_value *
                               tweak.values.player
                                   .cocaine_stack_absorption_multiplier[1] *
                               tweak.max_total_cocaine_stacks /
                               tweak.cocaine_stacks_convert_levels[2]
        ...
        self._risk = 0
        self._downs = 0
        self._max_downs = (Global.game_settings.one_down and 2 or
                              tweak_data.player.damage.LIVES_INIT) - 1
        if managers.modifiers and managers.modifiers.modify_value then
            self._max_downs = managers.modifiers:modify_value(
                                  "PlayerDamage:GetMaximumLives",
                                  self._max_downs)
        end

        self._reviver_count = 0

        self._owner:register_listener("PlayerStatus", {"health"},
                                      callback(self, self, "set_health"), false)
        self._owner:register_listener("PlayerStatus", {"stored_health"},
                                      callback(self, self, "set_stored_health"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"stored_health_max"},
                                      callback(self, self,
                                               "set_stored_health_max"), false)
        self._owner:register_listener("PlayerStatus", {"set_revives"},
                                      callback(self, self, "set_revives"), false)
        self._owner:register_listener("PlayerStatus", {"increment_downs"},
                                      callback(self, self, "increment_downs"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"reset_downs"},
                                      callback(self, self, "reset_downs"), false)
        self._owner:register_listener("PlayerStatus", {"detection"},
                                      callback(self, self, "set_detection"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"armor"},
                                      callback(self, self, "set_armor"), false)
        self._owner:register_listener("PlayerStatus", {"stamina"},
                                      callback(self, self, "set_stamina"), false)
        self._owner:register_listener("PlayerStatus", {"stamina_max"},
                                      callback(self, self, "set_stamina_max"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"damage_taken"},
                                      callback(self, self, "damage_taken"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"condition"},
                                      callback(self, self, "set_condition"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"start_condition_timer"},
                                      callback(self, self, "start_timer"), false)
        self._owner:register_listener("PlayerStatus", {"stop_condition_timer"},
                                      callback(self, self, "stop_timer"), false)
        self._owner:register_listener("PlayerStatus", {"pause_condition_timer"},
                                      callback(self, self, "pause_timer"), false)
        self._owner:register_listener("PlayerStatus", {"custom_radial"},
                                      callback(self, self, "set_custom_progress"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"ability_radial"},
                                      callback(self, self,
                                               "set_ability_progress"), false)
        self._owner:register_listener("PlayerStatus", {"activate_ability"},
                                      callback(self, self, "set_ability_active"),
                                      false)
        self._owner:register_listener("PlayerStatus", {"absorb_active"},
                                      callback(self, self, "set_absorb"), false)
        self._owner:register_listener("PlayerStatus", {"delayed_damage"},
                                      callback(self, self, "set_delayed_damage"),
                                      false)
        if managers.gameinfo then
            local panel_id = self._owner._id
            managers.gameinfo:register_listener(
                "HealthRadial_whisper_mode_listener" .. tostring(panel_id),
                "whisper_mode", "change",
                callback(self, self, "_whisper_mode_change"))
        end
    end

    function PlayerInfoComponent.PlayerStatus:destroy()
        self._owner:unregister_listener("PlayerStatus", {
            "health", "stored_health", "stored_health_max", "set_revives",
            "increment_downs", "reset_downs", "detection", "armor", "stamina",
            "stamina_max", "damage_taken", "condition", "start_condition_timer",
            "stop_condition_timer", "pause_condition_timer", "custom_radial",
            "ability_radial", "activate_ability", "absorb_active",
            "delayed_damage"
        })
        if managers.gameinfo then
            local panel_id = self._owner._id
            managers.gameinfo:unregister_listener(
                "HealthRadial_whisper_mode_listener" .. tostring(panel_id),
                "whisper_mode", "change")
        end
    ...
    function PlayerInfoComponent.PlayerStatus:update_settings()
        self._stamina_radial:set_visible(
            self._is_local_player and self._settings.STAMINA)
        self._condition_icon:set_color(self._settings.CONDITION_ICON_COLOR)

        local disabled = self._condition_icon:visible() or
                             not (HUDManager.DOWNS_COUNTER_PLUGIN and
                                 self._settings.DOWNCOUNTER)
        self._downs_counter:set_visible(not disabled and
                                            (not managers.groupai:state()
                                                :whisper_mode() or
                                                self:down_amount() > 0))
        self._detection_counter:set_visible(
            not disabled and not self._downs_counter:visible())
    ...
    function PlayerInfoComponent.PlayerStatus:rescale(factor)
        if PlayerInfoComponent.PlayerStatus.super.rescale(self, factor) then
            ...
            for id, component in pairs(self._components) do
                ...
                component:set_h(component:h() * factor)
                component:set_center(self._health_radial:w() / 2,
                                     self._health_radial:h() / 2)
            end
            self._downs_counter:set_font_size(
                self._downs_counter:font_size() * factor)
            self._detection_counter:set_font_size(
                self._detection_counter:font_size() * factor)
            self._condition_timer:set_font_size(
                self._condition_timer:font_size() * factor)
        end
    end

    function PlayerInfoComponent.PlayerStatus:set_is_local_player(state)
        if PlayerInfoComponent.PlayerStatus.super.set_is_local_player(self,
                                                                      state) then
            self._stamina_radial:set_visible(
                self._is_local_player and self._settings.STAMINA)
            ...
            if self._is_local_player then
                self._max_downs = self._max_downs +
    ...
    function PlayerInfoComponent.PlayerStatus:set_is_ai(state)
        if PlayerInfoComponent.PlayerStatus.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.PlayerStatus:set_is_waiting(state)
        if PlayerInfoComponent.PlayerStatus.super.set_is_waiting(self, state) and
            self:set_enabled("waiting", not self._is_waiting) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.PlayerStatus:set_health(current, total)
        ...
        self._health_radial:animate(callback(self, self, "_animate_set_health"),
                                    self._stored_health_radial, ratio)
    end

    function PlayerInfoComponent.PlayerStatus:set_stored_health(amount)
        self._stored_health = amount
        self._stored_health_radial:set_color(
            Color(math.min(self._stored_health, self._stored_health_max), 0, 0))
    end
    ...
    function PlayerInfoComponent.PlayerStatus:set_downs(amount)
        if amount and self._downs ~= amount then
            ...
            local progress = math.clamp(self:down_amount() / self._max_downs, 0,
                                        1)
            self._downs_counter:set_color(
                math.lerp(Color.white, Color(1, 1, 0.2, 0), progress))
            local disabled = self._condition_icon:visible() or
                                 not (HUDManager.DOWNS_COUNTER_PLUGIN and
                                     self._settings.DOWNCOUNTER)
            self._downs_counter:set_visible(
                not disabled and
    ...
    function PlayerInfoComponent.PlayerStatus:set_revives(value)
        ...
        if value == 0 then
            ...
            self._downs_counter:animate(
                callback(self, self, "_animate_low_life"),
                self._downs_counter:h() * 0.65, self._downs_counter:h() * 0.95)
        else
            self._downs_counter:stop()
    ...
    function PlayerInfoComponent.PlayerStatus:down_amount()
        return self._is_local_player and self._max_downs - self._downs or
                   self._downs
    end
    ...
    function PlayerInfoComponent.PlayerStatus:set_detection(risk)
        if risk and self._risk ~= risk then
            ...
            local color = self._risk < 50 and Color(1, 0, 0.8, 1) or
                              Color(1, 1, 0.2, 0)
            self._detection_counter:set_text(
                utf8.char(57363) .. tostring(self._risk))
    ...
    function PlayerInfoComponent.PlayerStatus:_whisper_mode_change(event, key,
                                                                   status)
        local disabled = self._condition_icon:visible() or
                             not (HUDManager.DOWNS_COUNTER_PLUGIN and
                                 self._settings.DOWNCOUNTER)
        self._downs_counter:set_visible(not disabled and
                                            (not status or self:down_amount() >
                                                0))
        self._detection_counter:set_visible(
            not disabled and not self._downs_counter:visible())
    end
    ...
    function PlayerInfoComponent.PlayerStatus:set_stamina(amount)
        ...
        if amount <=
            tweak_data.player.movement_state.stamina.MIN_STAMINA_THRESHOLD and
            not self._animating_low_stamina then
            self._animating_low_stamina = true
            self._stamina_radial:animate(
                callback(self, self, "_animate_low_stamina"))
        elseif amount >
            tweak_data.player.movement_state.stamina.MIN_STAMINA_THRESHOLD and
            self._animating_low_stamina then
    ...
    function PlayerInfoComponent.PlayerStatus:damage_taken()
        ...
        self._damage_indicator:animate(callback(self, self,
                                                "_animate_damage_taken"))
    end
    ...
    function PlayerInfoComponent.PlayerStatus:set_condition(icon_data)
        ...
        self._stamina_radial:set_visible(
            not visible and self._is_local_player and self._settings.STAMINA)
        if HUDManager.DOWNS_COUNTER_PLUGIN and self._downs_counter and
            self._detection_counter then
    ...
    function PlayerInfoComponent.PlayerStatus:set_ability_progress(current,
                                                                   total)
        local ratio = current / total
    ...
    function PlayerInfoComponent.PlayerStatus:set_ability_active(time_left,
                                                                 time_total)
        self._ability_radial_icon:stop()
        self._ability_radial_icon:animate(
            callback(self, self, "_animate_ability"), time_left, time_total)
    end
    ...
    function PlayerInfoComponent.PlayerStatus:set_delayed_damage(data)
        ...
        local health_damage = damage < health_current and damage or
                                  health_current
        local armor_damage_ratio =
            armor_damage > 0 and armor_damage / armor_max or 0
        ...
        self._radial_delayed_damage_armor:set_color(
            Color(1, armor_damage_ratio, 1 - armor_ratio, 0))
        self._radial_delayed_damage_health:set_color(
            Color(1, health_damage_ratio, 1 - health_ratio, 0))
    ...
    function PlayerInfoComponent.PlayerStatus:_animate_set_health(health_radial,
                                                                  stored_health_radial,
                                                                  new_ratio)
        ...
        while t < tt do
            t = t + coroutine.yield()
            local current_ratio = math.lerp(old_ratio, new_ratio,
                                            math.clamp(t / tt, 0, 1))
    ...
    function PlayerInfoComponent.PlayerStatus:_animate_low_stamina(
        stamina_radial)
        local t = 0
    ...
    function PlayerInfoComponent.PlayerStatus:_animate_low_life(text, min_size,
                                                                max_size)
        local t = 0
    ...
    function PlayerInfoComponent.PlayerStatus:_animate_ability(radial,
                                                               time_left,
                                                               duration)
        ...
        while t >= 0 do
            ...
            if self._reviver_count <= 0 then
                ...
                if t <= LOW then
                    ...
                    timer:set_font_size(math.lerp(self._panel:h() * 0.5,
                                                  self._panel:h() * 0.7, n))
                end
            end
        end
    ...
    PlayerInfoComponent.WaitingStatus = PlayerInfoComponent.WaitingStatus or
                                            class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.WaitingStatus:init(panel, owner, width, height,
                                                    settings)
        PlayerInfoComponent.WaitingStatus.super.init(self, panel, owner,
                                                     "waiting_status", width,
                                                     height)
        ...
        local detection_texture =
            "guis/textures/pd2/mission_briefing/inv_detection_meter"
        ...
        detection_right_bg:set_texture_rect(detection_right_bg:texture_width(),
                                            0,
                                            -detection_right_bg:texture_width(),
                                            detection_right_bg:texture_height())
        ...
        detection_right:set_texture_rect(detection_right:texture_width(), 0,
                                         -detection_right:texture_width(),
                                         detection_right:texture_height())
        ...
        self._detection_value:set_center(self._panel:w() / 2,
                                         self._panel:h() / 2 + 2)

        self._detection_ring = {detection_left, detection_right}
        self._components = {
            detection_left_bg, detection_right_bg, detection_left,
            detection_right
        }

        self:set_enabled("waiting", false)

        self._owner:register_listener("WaitingStatus", {"detection"},
                                      callback(self, self, "set_detection"),
                                      false)
    end
    ...
    function PlayerInfoComponent.WaitingStatus:set_is_local_player(state)
        if PlayerInfoComponent.WaitingStatus.super.set_is_local_player(self,
                                                                       state) and
            self:set_enabled("player", not self._is_local_player) then
            self._owner:arrange()
        end
    ...
    function PlayerInfoComponent.WaitingStatus:set_is_ai(state)
        if PlayerInfoComponent.WaitingStatus.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.WaitingStatus:set_is_waiting(state)
        if PlayerInfoComponent.WaitingStatus.super.set_is_waiting(self, state) and
            self:set_enabled("waiting", self._is_waiting) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.WaitingStatus:rescale(factor)
        if PlayerInfoComponent.WaitingStatus.super.rescale(self, factor) then
            ...
            self._detection_value:set_font_size(
                math.min(self._detection_value:font_size() * (max_w / w),
    ...
    PlayerInfoComponent.Carry = PlayerInfoComponent.Carry or
                                    class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Carry:init(panel, owner, player_height,
                                            team_height, settings)
        ...
        local component_size = self._owner._is_player and self._player_height or
                                   self._team_height / 2
        ...
        self._owner:register_listener("Carry", {"set_carry"},
                                      callback(self, self, "set"), false)
        self._owner:register_listener("Carry", {"clear_carry"},
                                      callback(self, self, "clear"), false)
    end
    ...
    function PlayerInfoComponent.Carry:rescale(factor)
        if PlayerInfoComponent.Carry.super.rescale(self, factor) then
            ...
            local component_size = self._owner._is_player and
                                       self._player_height or self._team_height /
                                       2
            self._icon:set_size(component_size, component_size)
            self._text:set_h(component_size)
            self._text:set_font_size(component_size * 0.8)
    ...
    function PlayerInfoComponent.Carry:arrange()
        local w = self._panel:w()
        local h = self._owner._is_player and self._player_height or
                      self._team_height
        ...
        if self:set_size(w, h) then self._owner:arrange() end
    end

    function PlayerInfoComponent.Carry:set(id, value) self:_update_carry(id) end

    function PlayerInfoComponent.Carry:clear() self:_update_carry(nil) end
    ...
    function PlayerInfoComponent.Carry:_update_carry(id)
        if self._current_carry ~= id then
            ...
            if id then
                local name_id = tweak_data.carry[id] and
                                    tweak_data.carry[id].name_id
                local carry_text = utf8.to_upper(
                                       name_id and
                                           managers.localization:text(name_id) or
                                           "UNKNOWN")
            ...
            if self:set_enabled("active", id) then self:arrange() end
        end
    end

    PlayerInfoComponent.CenterPanel = PlayerInfoComponent.CenterPanel or
                                          class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.CenterPanel:init(panel, owner, height, settings)
        PlayerInfoComponent.CenterPanel.super.init(self, panel, owner,
                                                   "center_panel", 0, height)

        self._settings = settings

        self._weapons = PlayerInfoComponent.Weapons:new(self._panel, self,
                                                        height, settings)
        self._equipment = PlayerInfoComponent.Equipment:new(self._panel, self,
                                                            height, settings)
        self._special_equipment = PlayerInfoComponent.SpecialEquipment:new(
                                      self._panel, self, height, settings)
        self._interaction = PlayerInfoComponent.Interaction:new(self._panel,
                                                                self, height,
                                                                settings)

        self._components = {
            self._weapons, self._equipment, self._special_equipment,
            self._interaction
        }
        ...
        self._owner:register_listener("CenterPanel", {"interaction_start"},
                                      callback(self, self, "_interaction_start"),
                                      false)
        self._owner:register_listener("CenterPanel", {"interaction_stop"},
                                      callback(self, self, "_interaction_stop"),
                                      false)
    end
    ...
    function PlayerInfoComponent.CenterPanel:set_is_local_player(state)
        if PlayerInfoComponent.CenterPanel.super
            .set_is_local_player(self, state) then
            for _, component in pairs(self._components) do
    ...
    function PlayerInfoComponent.CenterPanel:arrange()
        ...
        if enable_changed or size_change then self._owner:arrange() end
    end
    ...
    function PlayerInfoComponent.CenterPanel:_interaction_start(id, timer)
        if not self._settings.INTERACTION.HIDE and
            (self._settings.INTERACTION.MIN_DURATION or 0) <= timer then
            self._panel:stop()
    ...
    PlayerInfoComponent.Weapons = PlayerInfoComponent.Weapons or
                                      class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Weapons:init(panel, owner, height, settings)
        PlayerInfoComponent.Weapons.super.init(self, panel, owner, "weapons", 0,
                                               height)
        ...
        for i = 1, self._weapon_count, 1 do
            local weapon = PlayerInfoComponent.Weapon:new(self._panel, self, i,
                                                          height, self._settings)
            table.insert(self._weapons, weapon)

            local text_h = self._aggregate_ammo_panel:h() *
                               (1 / self._weapon_count)
            ...
            self._aggregate_ammo_panel:set_w(
                math.max(w, self._aggregate_ammo_panel:w()))
        end

        -- self:_weapon_selected(1)

        self._owner:register_listener("Weapons", {"weapon_selected"},
                                      callback(self, self, "_weapon_selected"),
                                      false)
        self._owner:register_listener("Weapons", {"ammo_amount"},
                                      callback(self, self, "_ammo_amount"),
                                      false)
        self._owner:register_listener("Weapons", {"weapon_fire_mode"},
                                      callback(self, self,
                                               "_weapon_event_handler"), true)
        self._owner:register_listener("Weapons", {"weapon"}, callback(self,
                                                                      self,
                                                                      "_weapon_event_handler"),
                                      true)
        self._owner:register_listener("Weapons", {"available_fire_modes"},
                                      callback(self, self,
                                               "_weapon_event_handler"), true)
    end

    function PlayerInfoComponent.Weapons:destroy()
        for _, weapon in pairs(self._weapons) do weapon:destroy() end

        self._owner:unregister_listener("Weapons", {
            "weapon_selected", "ammo_amount", "weapon_fire_mode", "weapon",
    ...
    function PlayerInfoComponent.Weapons:update_settings()
        for _, weapon in pairs(self._weapons) do weapon:update_settings() end

        self._aggregate_ammo_panel:set_visible(
            self._settings.WEAPON.AMMO.TOTAL_AMMO_ONLY and true or false)
        self:arrange()
    end
    ...
    function PlayerInfoComponent.Weapons:rescale(factor)
        if PlayerInfoComponent.Weapons.super.rescale(self, factor) then
            ...
            self._aggregate_ammo_panel:set_w(
                self._aggregate_ammo_panel:w() * factor)
            self._aggregate_ammo_panel:set_h(
                self._aggregate_ammo_panel:h() * factor)
    ...
    function PlayerInfoComponent.Weapons:set_is_ai(state)
        if PlayerInfoComponent.CenterPanel.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.Weapons:_ammo_amount(slot, mag_current,
                                                      mag_max, total_current,
                                                      total_max)
        PlayerInfoComponent.Weapons._update_ammo_text(
            self._aggregate_ammo[slot], total_current, total_max)
        self._weapons[slot]:set_ammo_amount(mag_current, mag_max, total_current,
                                            total_max)
    end
    ...
    function PlayerInfoComponent.Weapons._update_ammo_text(component, current,
                                                           max) -- Static
    ...
    PlayerInfoComponent.Weapon = PlayerInfoComponent.Weapon or
                                     class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Weapon:init(panel, owner, slot, height,
                                             settings)
        PlayerInfoComponent.Weapon.super.init(self, panel, owner,
                                              "weapon_" .. tostring(slot), 0,
                                              height)
        ...
        self._icon_panel = self._panel:panel(
                               {name = "icon_panel", w = height * 2, h = height})

        self._bg_panel = HUDBGBox_create(self._panel, {w = w, h = h}, {})
        ...
        self._ammo_panel = self._panel:panel({name = "ammo_panel", h = height})
    ...
    function PlayerInfoComponent.Weapon:update_settings()
        ...
        if data.ICON.HIDE then
            ...
            unselected[self._icon_panel] =
                unselected[self._icon_panel] and false
        ...
        if data.FIREMODE then
            if data.FIREMODE.HIDE then
                selected[self._fire_mode_panel] =
                    selected[self._fire_mode_panel] and false
                unselected[self._fire_mode_panel] =
                    unselected[self._fire_mode_panel] and false
            elseif data.FIREMODE.SELECTED_ONLY then
                selected[self._fire_mode_panel] =
                    selected[self._fire_mode_panel] and true
                unselected[self._fire_mode_panel] =
                    unselected[self._fire_mode_panel] and false
            elseif data.FIREMODE.UNSELECTED_ONLY then
                selected[self._fire_mode_panel] =
                    selected[self._fire_mode_panel] and false
                unselected[self._fire_mode_panel] =
                    unselected[self._fire_mode_panel] and true
            end
        end

        if data.AMMO.HIDE then
            selected[self._ammo_panel] = selected[self._ammo_panel] and false
            unselected[self._ammo_panel] =
                unselected[self._ammo_panel] and false
    ...
    function PlayerInfoComponent.Weapon:arrange()
        ...
        local component_order = {
            self._icon_panel, self._fire_mode_panel, self._ammo_panel
        }
        ...
        if changed_enabled or changed_size then self._owner:arrange() end
    end
    ...
    function PlayerInfoComponent.Weapon:set_selected(state)
        ...
        for component, visible in pairs(self._component_visibility[state and
                                            "selected" or "unselected"]) do
    ...
    function PlayerInfoComponent.Weapon:set_ammo_amount(mag_current, mag_max,
                                                        total_current, total_max)
        PlayerInfoComponent.Weapons._update_ammo_text(
            self._ammo_panel:child("mag"), mag_current, mag_max)
        PlayerInfoComponent.Weapons._update_ammo_text(
            self._ammo_panel:child("total"), total_current, total_max)
    end
    ...
    function PlayerInfoComponent.Weapon:set_weapon(id, silencer)
        ...
        local bitmap_texture, text = PlayerInfoComponent.Base
                                         .get_item_icon_data(
                                         weapon_skin and "weapon_skin" or
                                             "weapon", id)
    ...
    PlayerInfoComponent.Equipment = PlayerInfoComponent.Equipment or
                                        class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Equipment:init(panel, owner, height, settings)
        PlayerInfoComponent.Equipment.super.init(self, panel, owner,
                                                 "equipment", 0, height)
        ...
        for i, name in ipairs(self._equipment_types) do
            local panel = self._panel:panel(
                              {name = name, h = size, visible = false})
        ...
        self._owner:register_listener("Equipment", {"throwable"},
                                      callback(self, self, "set_throwable"),
                                      false)
        self._owner:register_listener("Equipment", {"throwable_amount"},
                                      callback(self, self,
                                               "set_throwable_amount"), false)
        self._owner:register_listener("Equipment", {"cable_tie"},
                                      callback(self, self, "set_cable_tie"),
                                      false)
        self._owner:register_listener("Equipment", {"cable_tie_amount"},
                                      callback(self, self,
                                               "set_cable_tie_amount"), false)
        self._owner:register_listener("Equipment", {"deployable"},
                                      callback(self, self, "set_deployable"),
                                      false)
        self._owner:register_listener("Equipment", {"deployable_amount"},
                                      callback(self, self,
                                               "set_deployable_amount"), false)
        self._owner:register_listener("Equipment",
                                      {"deployable_amount_from_string"},
                                      callback(self, self,
                                               "set_deployable_amount_from_string"),
                                      false)
        self._owner:register_listener("Equipment", {"throwable_cooldown"},
                                      callback(self, self,
                                               "set_throwable_cooldown"), false)
        self._owner:register_listener("Equipment", {"throwable_cooldown_stop"},
                                      callback(self, self,
                                               "stop_throwable_cooldown"), false)
    end

    function PlayerInfoComponent.Equipment:destroy()
        self._owner:unregister_listener("Equipment", {
            "deployable_amount_from_string", "deployable_amount", "deployable",
            "cable_tie_amount", "cable_tie", "throwable_amount", "throwable",
            "throwable_cooldown", "throwable_cooldown_stop"
        })
    ...
    function PlayerInfoComponent.Equipment:set_is_ai(state)
        if PlayerInfoComponent.Equipment.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.Equipment:arrange()
        ...
        if change_enable or change_size then self._owner:arrange() end
    end
    ...
    function PlayerInfoComponent.Equipment:set_cable_tie(icon)
        ...
        self._panel:child("cable_ties"):child("icon"):set_image(texture, unpack(
                                                                    texture_rect))
    end
    ...
    function PlayerInfoComponent.Equipment:set_cable_tie_amount(amount)
        ...
        text:set_range_color(0, amount < 10 and 1 or 0,
    ...
    function PlayerInfoComponent.Equipment:set_throwable(icon)
        ...
        self._panel:child("throwables"):child("icon"):set_image(texture, unpack(
                                                                    texture_rect))
    end
    ...
    function PlayerInfoComponent.Equipment:set_throwable_cooldown(time_left,
                                                                  time_total)
        self._throwable_data.cooldown = managers.player:player_timer():time() +
                                            time_left
        if self._throwable_data.amount <= 0 then
            ...
            panel:animate(callback(self, self, "_animate_throwable_cooldown"),
                          time_left)
        end
    end
    ...
    function PlayerInfoComponent.Equipment:set_deployable(icon)
        ...
        self._panel:child("deployables"):child("icon"):set_image(texture,
                                                                 unpack(
                                                                     texture_rect))
    end
    ...
    function PlayerInfoComponent.Equipment:set_deployable_amount_from_string(
        amounts)
        local text_str = ""
        local color_range = {}
        for i = 1, #amounts do
            ...
            if amount > 0 then
                ...
                text_str = text_str .. string.format("%02.0f", amount) ..
                               (has_next and "|" or "")
            end
        end
    ...
    function PlayerInfoComponent.Equipment:set_bodybag(icon) -- equipment_body_bag
        local texture, texture_rect = tweak_data.hud_icons:get_icon_data(icon)
        self._panel:child("body_bags"):child("icon"):set_image(texture, unpack(
                                                                   texture_rect))
    end
    ...
    function PlayerInfoComponent.Equipment:_animate_throwable_cooldown(panel,
                                                                       time_left)
        ...
        while time_left > 0 and self._animating_throwable_cooldown do
            ...
            text:set_range_color(0, math.ceil(time_left) < 10 and 1 or 0,
                                 Color('FF7575'):with_alpha(0.5))
        end

        self:stop_throwable_cooldown(false)
    end

    PlayerInfoComponent.SpecialEquipment =
        PlayerInfoComponent.SpecialEquipment or class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.SpecialEquipment:init(panel, owner, height,
                                                       settings)
        PlayerInfoComponent.SpecialEquipment.super.init(self, panel, owner,
                                                        "special_equipment", 0,
                                                        height)
        ...
        self._owner:register_listener("SpecialEquipment",
                                      {"add_special_equipment"},
                                      callback(self, self, "add"), false)
        self._owner:register_listener("SpecialEquipment",
                                      {"remove_special_equipment"},
                                      callback(self, self, "remove"), false)
        self._owner:register_listener("SpecialEquipment",
                                      {"special_equipment_amount"},
                                      callback(self, self, "set_amount"), false)
        self._owner:register_listener("SpecialEquipment",
                                      {"clear_special_equipment"},
                                      callback(self, self, "clear"), false)
    end

    function PlayerInfoComponent.SpecialEquipment:destroy()
        self._owner:unregister_listener("SpecialEquipment", {
            "clear_special_equipment", "special_equipment_amount",
            "remove_special_equipment", "add_special_equipment"
        })
    ...
    function PlayerInfoComponent.SpecialEquipment:update_settings()
        ...
        if self._items_per_column ~=
            (self._settings.SPECIAL_EQUIPMENT_ROWS or 3) then
            self._items_per_column = self._settings.SPECIAL_EQUIPMENT_ROWS or 3
    ...
    function PlayerInfoComponent.SpecialEquipment:set_is_ai(state)
        if PlayerInfoComponent.SpecialEquipment.super.set_is_ai(self, state) and
            self:set_enabled("ai", not self._is_ai) then
            self._owner:arrange()
        end
    end
    ...
    function PlayerInfoComponent.SpecialEquipment:add(id, icon)
        ...
        local panel = self._panel:panel({name = id})
    ...
    PlayerInfoComponent.Interaction = PlayerInfoComponent.Interaction or
                                          class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Interaction:init(panel, owner, height, settings)
        PlayerInfoComponent.Interaction.super.init(self, panel, owner,
                                                   "interaction", 0, height)
        ...
        self._owner:register_listener("Interaction", {"interaction_start"},
                                      callback(self, self, "start"), false)
        self._owner:register_listener("Interaction", {"interaction_tweak"},
                                      callback(self, self, "set_tweak_data"),
                                      false)
        self._owner:register_listener("Interaction", {"interaction_stop"},
                                      callback(self, self, "stop"), false)
    end

    function PlayerInfoComponent.Interaction:destroy()
        self._owner:unregister_listener("Interaction", {
            "interaction_start", "interaction_stop", "interaction_tweak"
        })
    ...
    function PlayerInfoComponent.Interaction:start(id, timer)
        ...
        if not self._settings.INTERACTION.HIDE and
            ...
            if tweak_entry and
                (tweak_entry.action_text_id or tweak_entry.quantity) then
                text_id = tweak_entry.action_text_id or
                              "hud_deploying_equipment"
                macros = {
                    EQUIPMENT = (tweak_entry.text_id and
                        managers.localization:text(tweak_entry.text_id) or "N/A"),
                    BTN_INTERACT = managers.localization:get_default_macro(
                        "BTN_INTERACT")
                }
            end
    ...
    function PlayerInfoComponent.Interaction:set_tweak_data(tweak_data)
        if tweak_data then self._tweak_data = tweak_data end
    end
    ...
    function PlayerInfoComponent.Interaction:stop(success)
        if self:visible() then
            ...
            self._text:set_text(managers.localization:to_upper_text(
                                    success and
                                        "wolfhud_customhud_interaction_done" or
                                        "wolfhud_customhud_interaction_aborted"))
            -- self._interaction:set_enabled("active", false)
            -- self:arrange()
        end
    end
    ...
    function PlayerInfoComponent.Interaction:_animate(panel, timer)
        ...
        while timer > t do
            ...
            if r < 0.5 then
                ...
                self._progress_bar:set_gradient_points(
                    {0, Color(r_max, g_min, b), 1, Color(r_max, green, b)})
            else
                local red = math.clamp(1 - (r - 0.5) * 2, 0, 1) *
                                (r_max - r_min) + r_min
                self._progress_bar:set_gradient_points(
                    {
                        0, Color(r_max, g_min, b), 0.5 / r,
                        Color(r_max, g_max, b), 1, Color(red, g_max, b)
                    })
            end
        ...
        self._progress_bar:set_gradient_points(
            {
                0, Color(r_max, g_min, b), 0.5, Color(r_max, g_max, b), 1,
                Color(r_min, g_max, b)
            })
    end

    -- Unused, remember to update arrange handling
    PlayerInfoComponent.Throwable = PlayerInfoComponent.Throwable or
                                        class(PlayerInfoComponent.Base)
    function PlayerInfoComponent.Throwable:init(panel, owner, height)
        PlayerInfoComponent.Throwable.super.init(self, panel, owner,
                                                 "throwable", 0, height)
    ...
    function PlayerInfoComponent.Throwable:arrange()
        ...
        if w > 0 then w = w - MARGIN end

        PlayerInfoComponent.Throwable.super.arrange(self, w, h)
        if self._owner then self._owner:arrange() end
    end

    function PlayerInfoComponent.Throwable:set_icon(id)
        local texture, text = PlayerInfoComponent.Base.get_item_icon_data(
                                  "throwable", id)
    ...
    PlayerInfoComponent.Melee = PlayerInfoComponent.Melee or
                                    class(PlayerInfoComponent.Base)
    PlayerInfoComponent.Armor = PlayerInfoComponent.Armor or
                                    class(PlayerInfoComponent.Base)
    PlayerInfoComponent.Deployable = PlayerInfoComponent.Deployable or
                                         class(PlayerInfoComponent.Base)
...
if RequiredScript == "lib/managers/hudmanagerpd2" then
    ...
    local remove_teammate_carry_info_original =
        HUDManager.remove_teammate_carry_info
    ...
    function HUDManager:_create_teammates_panel(hud, ...)
        ...
        local j = 1
        HUDManager.PLAYER_PANEL = math.max(CriminalsManager.MAX_NR_CRIMINALS,
                                           HUDManager.PLAYER_PANEL) -- TEST
        ...
        for i = 1, num_panels do
            ...
            if is_player then
                align = WolfHUD:getSetting({"CustomHUD", "PLAYER", "POSITION"},
                                           2) < 3 and "left" or "right"
            elseif j <= 7 then
                align = WolfHUD:getSetting(
                            {"CustomHUD", "TEAMMATE", "POSITION"}, 1) < 3 and
                            "left" or "right"
            else
                align = WolfHUD:getSetting(
                            {"CustomHUD", "TEAMMATE", "POSITION"}, 1) > 1 and
                            "right" or "left"
            end

            local teammate = HUDTeammateCustom:new(i, teammates_panel,
                                                   is_player, align)
    ...
    function HUDManager:add_weapon(data, ...)
        ...
        if wbase._cosmetics_data and wbase._cosmetics_data.name_id then
            ...
            if skin_tweak and not skin_tweak.is_a_color_skin and
                (table.contains(skin_tweak.weapon_ids or {}, weapon_id) or
                    (skin_tweak.weapon_id and skin_tweak.weapon_id == weapon_id) ~=
                    (skin_tweak.use_blacklist or false)) then
                name_id = skin_id
            end
        end

        self:set_teammate_weapon(HUDManager.PLAYER_PANEL, data.inventory_index,
                                 name_id, wbase:got_silencer())

        local active_mode = wbase:fire_mode()
        local fire_modes = {}
        if wbase:fire_mode() == "single" or
            (wbase:can_toggle_firemode() and not wbase._locked_fire_mode) then
            table.insert(fire_modes, {"single", "S"})
        end
        if wbase.can_use_burst_mode and wbase:can_use_burst_mode() and
            not wbase._locked_fire_mode then
            active_mode = wbase:in_burst_mode() and "burst" or active_mode
            table.insert(fire_modes, {"burst", "B"})
        end
        if wbase:fire_mode() == "auto" or
            (wbase:can_toggle_firemode() and not wbase._locked_fire_mode) then
            table.insert(fire_modes, {"auto", "A"})
        end

        self:set_teammate_available_fire_modes(HUDManager.PLAYER_PANEL,
                                               data.inventory_index, fire_modes)
        self:set_teammate_weapon_firemode(HUDManager.PLAYER_PANEL,
                                          data.inventory_index, active_mode)
    ...
    function HUDManager:teammate_progress(peer_id, type_index, enabled,
                                          tweak_data_id, ...)
        ...
        elseif type_index == 3 then
            interact_tweak = {
                [tweak_data_id] = {action_text_id = "hud_starting_heist"}
            }
        end

        local character_data = managers.criminals:character_data_by_peer_id(
                                   peer_id)
        if character_data and interact_tweak then
            self._teammate_panels[character_data.panel_id]:set_interaction_tweak(
                enabled, interact_tweak)
        end

        teammate_progress_original(self, peer_id, type_index, enabled,
                                   tweak_data_id, ...)
    end
    ...
    function HUDManager:reset_player_hpbar()
        local crim_entry = managers.criminals:character_static_data_by_name(
                               managers.criminals:local_character_name())
        if not crim_entry then return end
        local color_id = managers.network:session():local_peer():id()
        self:set_teammate_callsign(HUDManager.PLAYER_PANEL, color_id)
        self:set_teammate_name(HUDManager.PLAYER_PANEL,
    ...
    function HUDManager:set_ai_stopped(ai_id, stopped, ...)
        ...
        if teammate_panel and teammate_panel:is_ai() then
            ...
            teammate_panel:set_condition(
                stopped and "ai_stopped" or "mugshot_normal",
                stopped and "HOLD" or "NORMAL")
                ...
                if string.gsub(label.character_name, "%W", "") == name then
                    if stopped and not label.panel:child("stopped") then
                        local texture, texture_rect =
                            tweak_data.hud_icons:get_icon_data("ai_stopped")
                        local label_stop_icon =
                            label.panel:bitmap(
                                {
                                    name = "stopped",
                                    texture = texture,
    ...
    function HUDManager:arrange_teammate_panels()
        ...
        if player_hud and player_panel then
            ...
            local function getCenterX(hud_w, panel_w, pos_id)
                ...
                return pos_id <= 1 and panel_w2 or pos_id == 2 and hud_w2 or
                           (hud_w - panel_w2)
            end

            -- Seperate Player Panel setup, so its always the most bottom one
            local player_pos = math.clamp(
                                   WolfHUD:getSetting(
                                       {"CustomHUD", "PLAYER", "POSITION"}, 2),
                                   1, 3)
            local player_w, player_h = player_panel:w() or 0,
                                       player_panel:h() or 0
            ...
            teammate_offset[player_pos] =
                math.round(teammate_offset[player_pos] + player_panel:h() +
                               MARGIN)

            local j = 0
            local MAX_STACK_SIZE = math.max(
                                       math.ceil(#self._teammate_panels / 2), 7)
            local teammate_pos = {
                math.clamp(WolfHUD:getSetting(
                               {"CustomHUD", "TEAMMATE", "POSITION"}, 1), 1, 3)
            }
            ...
            for i, teammate in ipairs(self._teammate_panels) do
                ...
                if i ~= HUDManager.PLAYER_PANEL and panel:visible() then
                    ...
                    panel:set_center_x(getCenterX(hud_w, panel:w(),
                                                  teammate_pos[team_stack]))
                    panel:set_bottom(hud_h -
                                         teammate_offset[teammate_pos[team_stack]])
                    teammate:set_alignment(
                        (teammate_pos[team_stack] < 3) and "left" or "right")

                    teammate_offset[teammate_pos[team_stack]] =
                        math.round(teammate_offset[teammate_pos[team_stack]] +
                                       panel:h() + MARGIN)
                    j = j + 1
                end
            end
            ...
            if self._hud_driving and self._hud_driving.set_offset and
                self._hud_driving:panel():visible() then
                self._hud_driving:set_offset(
                    teammate_offset[align_id] + HUDDriving._MARGIN,
                    align_id < 2 and "left" or "right")
                teammate_offset[align_id] =
                    math.round(self._hud_driving:panel():top())
            ...
            if self._hud_chat_ingame and self._hud_chat_ingame.set_offset then
                self._hud_chat_ingame:set_offset(
                    teammate_offset[align_id] + HUDChat.LINE_HEIGHT,
                    align_id < 2 and "left" or "right")
            end
        end
    end
    ...
    function HUDManager:change_hud_setting(type, setting, value)
        if setting[1] == "POSITION" then
            ...
            for i, panel in ipairs(self._teammate_panels) do
                if panel._is_player and type == "PLAYER" or not panel._is_player and
                    type == "TEAMMATE" then
    ...
    function HUDManager:teammate_panel(i) return self._teammate_panels[i] end

    function HUDManager:set_player_carry_info(carry_id, value)
        self._teammate_panels[HUDManager.PLAYER_PANEL]:set_carry_info(carry_id,
                                                                      value)
    end
        ...
        if peer_id == local_peer:id() then
            ...
            if outfit then
                ...
                for selection, data in
                    ipairs({outfit.secondary, outfit.primary}) do
                    local weapon_id =
                        managers.weapon_factory:get_weapon_id_by_factory_id(
                            data.factory_id)
                    local skin_id = data.cosmetics and data.cosmetics.id
                    local skin_tweak =
                        tweak_data.blackmarket.weapon_skins[skin_id]
                    local weapon_skin = skin_tweak and
                                            not skin_tweak.is_a_color_skin and
                                            (table.contains(
                                                skin_tweak.weapon_ids or {},
                                                weapon_id) or
                                                (skin_tweak.weapon_id and
                                                    skin_tweak.weapon_id ==
                                                    weapon_id) ~=
                                                (skin_tweak.use_blacklist or
                                                    false)) or false
                    local silencer = managers.weapon_factory:has_perk(
                                         "silencer", data.factory_id,
                                         data.blueprint)
                    self:set_teammate_weapon(panel_id, selection,
                                             weapon_skin and skin_id or
                                                 weapon_id, silencer)
                    ...
                    if tweak then
                        ...
                        self:set_teammate_ammo_amount(panel_id, selection,
                                                      clip_max, clip_max,
                                                      total_max, total_max)
                    end
                end
                ...
                -- Perk deck
                local deck_index, deck_level =
                    unpack(outfit.skills.specializations)
                local skills = outfit.skills.skills
                self:set_teammate_specialization(panel_id, tonumber(deck_index),
                                                 tonumber(deck_level))
                self:set_teammate_skills(panel_id, skills)

                -- Detection
                local detection =
                    managers.blackmarket:get_suspicion_offset_of_peer(peer,
                                                                      tweak_data.player
                                                                          .SUSPICION_OFFSET_LERP or
                                                                          0.75)
                self:set_teammate_detection(panel_id,
    ...
    function HUDManager:increment_teammate_kill_count_detailed(i, unit,
                                                               weapon_id,
                                                               weapon_type,
                                                               weapon_slot)
        -- TODO
    ...
    function BagPresenter:init(parent_panel)
        ...
        self._panel = parent_panel:panel(
                          {name = "bag_presenter", visible = false})
    ...
    function BagPresenter:clear_carry() self:set_carry() end
    ...
    function BagPresenter:_animate_present(panel, panel_w, panel_h)
        local player_panel =
            managers.hud:teammate_panel(HUDManager.PLAYER_PANEL)
